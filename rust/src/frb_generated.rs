...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1062690645;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        43 => wire__crate__api__wallet__Wallet_send_impl(port, ptr, rust_vec_len, data_len),
        44 => {
            wire__crate__api__wallet__Wallet_stream_balance_impl(port, ptr, rust_vec_len, data_len)
        }
        47 => wire__crate__api__init__init_app_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        45 => wire__crate__api__wallet__generate_hex_seed_impl(ptr, rust_vec_len, data_len),
        46 => wire__crate__api__wallet__generate_seed_impl(ptr, rust_vec_len, data_len),
        48 => wire__crate__api__wallet__parse_input_impl(ptr, rust_vec_len, data_len),
        49 => wire__crate__api__payment_request__payment_request_encode_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        50 => wire__crate__api__token__token_parse_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
