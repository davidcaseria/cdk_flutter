...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 537153656;
...
fn wire__crate__api__wallet__MultiMintWallet_find_wallet_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::SseCodec, _, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "MultiMintWallet_find_wallet",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| async move {
                transform_result_sse::<_, ()>(
                    (move || async move {
                        ...
                        let api_that_guard = api_that_guard.unwrap();
                        let output_ok = Result::<_, ()>::Ok(
                            crate::api::wallet::MultiMintWallet::find_wallet(
                                &*api_that_guard,
                                api_amount,
                                api_mint_urls,
                            )
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        5 => wire__crate__api__wallet__MultiMintWallet_create_or_get_wallet_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        6 => wire__crate__api__wallet__MultiMintWallet_find_wallet_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        28 => wire__crate__api__wallet__Wallet_get_mint_impl(port, ptr, rust_vec_len, data_len),
        29 => {
        ...
        37 => wire__crate__api__wallet__Wallet_send_impl(port, ptr, rust_vec_len, data_len),
        38 => {
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        34 => wire__crate__api__wallet__Wallet_new_from_hex_seed_impl(ptr, rust_vec_len, data_len),
        39 => wire__crate__api__wallet__generate_hex_seed_impl(ptr, rust_vec_len, data_len),
        40 => wire__crate__api__wallet__generate_seed_impl(ptr, rust_vec_len, data_len),
        42 => wire__crate__api__wallet__parse_input_impl(ptr, rust_vec_len, data_len),
        43 => wire__crate__api__token__token_parse_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
