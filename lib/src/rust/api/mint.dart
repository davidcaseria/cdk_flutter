...
@freezed
sealed class HttpRoutePath with _$HttpRoutePath {
  const HttpRoutePath._();

  const factory HttpRoutePath.mintQuote(
    String field0,
  ) = HttpRoutePath_MintQuote;
  const factory HttpRoutePath.mint(
    String field0,
  ) = HttpRoutePath_Mint;
  const factory HttpRoutePath.meltQuote(
    String field0,
  ) = HttpRoutePath_MeltQuote;
  const factory HttpRoutePath.melt(
    String field0,
  ) = HttpRoutePath_Melt;
  const factory HttpRoutePath.swap() = HttpRoutePath_Swap;
  const factory HttpRoutePath.checkstate() = HttpRoutePath_Checkstate;
  const factory HttpRoutePath.restore() = HttpRoutePath_Restore;
  const factory HttpRoutePath.mintBlindAuth() = HttpRoutePath_MintBlindAuth;
  const factory HttpRoutePath.ws() = HttpRoutePath_Ws;
}
